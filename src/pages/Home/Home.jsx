...
const Home = () => {
  ...
  const getAllNotes = async () => {
    try {
      ...
      const res = await axios.get("https://dis-caudal.onrender.com/api/note/all", {
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete(
        ...
        "https://dis-caudal.onrender.com/api/note/delete/" + noteId,
        { withCredentials: true }
      );
  ...
  const onSearchNote = async (query) => {
    try {
      ...
      const res = await axios.get("https://dis-caudal.onrender.com/api/note/search", {
        params: { query },
        withCredentials: true,
      });
  ...
  const updateIsPinned = async (noteData) => {
    ...
    try {
      const res = await axios.put(
        ...
        "https://dis-caudal.onrender.com/api/note/update-note-pinned/" + noteId,
  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        {allNotes.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mt-8 mr-4 max-md:m-5">
      ...
      <Modal
        ...
        contentLabel=""
        className="w-[29%] rounded-[50px] max-md:w-[60%] max-sm:w-[70%] max-h-3/4 bg-white rounded-[50px] mx-auto mt-14 p-0" // Removed padding
      >
        <AddEditNotes
          onClose={() =>
            setOpenAddEditModal({ isShown: false, type: "add", data: null })
